...
<body>
    ...
    <div id="update-user-main-content">
        <div class="page-header-container">
            <p id='page-header-title'>Review Content Collection Access permission</p>
                    ...
                    <?php foreach ($params['data'] as $data) { ?>
                        <div class="item-info-container">
                            ...
                            <div class='item-info-btn-side'>
                                <form action="/admin/approve-content-collection-access-permission" method="POST">
                                    ...
                                    <button class="btn action-btn-2-edit btn-update>Remove">Approve</button>
                                </form>
                                <form action="/admin/reject-content-collection-access-permission" method="POST">
                                    <input type='hidden' name='collection-id' value='<?= $data->content_collection_id ?>' />
                                    <input type='hidden' name='usergroup-id' value='<?= $data->group_id ?>' />
                                    <button class="btn action-btn-3-edit btn-update>Remove">Reject</button>
                                </form>
                            </div>
                        </div>
                    <?php } ?>
