...
<body>
    ...
    <div class="content-container">
            ...
            <?php foreach ($params['requests'] as $req) { ?>
                <div class="user-group-info">
                    ...
                    <div class="block-e">
                        ...
                        <form action="/admin/approve-cc-request" method="POST">
                            <button class="btn btn-success mr-1 mb-1 btn2-edit" type="submit" name="content-collection-id" value="<?= $req->id ?>">Approve</button>
                        </form>
        ...
        <div id="reject-message-container">
            ...
            <form action="/admin/reject-content-collection" method="POST">
