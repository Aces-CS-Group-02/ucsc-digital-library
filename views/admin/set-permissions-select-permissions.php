                    ...
                    <?php if ($params['page_step'] == 3) { ?>
                        <div class="item-info-container">
                            ...
                            <div class='item-info-block'>
                                ...
                                <span>:</span>
                                <p><?= $params['collection']->first_name ?> <?= $params['collection']->last_name ?></p>
                            </div>

                            <div class='item-info-block'>
                                <p class='item-info-header-block'>Description</p>
                                <span>:</span>
                                <p><?php if ($params['collection']->description == '') {
                                        echo 'N/A';
                                    } else {
                                        echo $params['collection']->description;
                                    } ?></p>
                            </div>
    ...
    <Script>
        (() => {
            ...
            cancelBtn.addEventListener('click', () => {
                window.location = '/admin/set-content-collection-access-permission';
            })
