...
<body>
    ...
    <div id="update-user-main-content">
        ...
        <div class="wrapper">
            ...
            <div class="btn-row">
                <button class="btn <?php echo '' . ($params['upload_steps'] >= 1 ? "btn-info" : "btn-light") . ''; ?> mr-1 step-next-btn" onclick="window.location='/admin/upload-content?content_id=<?php echo $params['data']['content_id']; ?>';">Step 1</button>
                <button class="btn btn-primary mr-1 step-next-btn">Step 2</button>
            ...
            <form id="create-community-form" action="" method="POST">
                <div class="input-row-group">
                    ...
                    <div class="btn-row content-align-right">
                        ...
                        <button class="btn btn-secondary mr-1" onclick="window.location='/admin/upload-content?content_id=<?php echo $params['data']['content_id']; ?>';" type="button">Back</button>
