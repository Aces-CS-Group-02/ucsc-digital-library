...
<body>
    ...
    <div class="info-dashboard-main-content">
        <div class="admin-dashboard-text">
            <p id="page-header-title">Publish Content Details</p>
            ...
            <div class="btn-grid-container">
                <div class="btn-container">
                    <form action="/admin/publish-content/publish" method="POST">
                        <button class="btn btn-success mr-1 mb-1 btn-edit" onclick="confirm('Are you sure?')" name="content_id" value="<?= $content->content_id ?>">Publish</button>
                    </form>
                </div>
                <div class="info-items-container">
                            ...
                            <p class="line-clamp line-clamp-1-description <?php if ($content->keywords === []) {
                                                                                echo "gray-out";
                                                                                    ...
                                                                                    if ($content->keywords === []) {
                                                                                        ...
                                                                                        // echo $content->keywords[0]['keywords'];
                                                                                        // for ($i = 1; $i < count($content->keywords); $i++) {
                                                                                        //     echo ', ' . $content->keywords[$i]['keywords'];
                                                                                        // }
                                                                                    }  ?></p>
                    ...
                    <div class="info-item-container ">
                        ...
                        <div class="info-item-content ">
                            <a href="/content/view?content_id=<?php echo $content->content_id; ?>">View Contents</a>
                        </div>
                    </div>
                    <div class="info-item-container ">
                        <div class="info-item-title">
