...
<body>
    ...
    <div id="users-ud-main-content">
        <div class="page-header-container">
            <p id="page-header-title">My user groups</p>
        </div>
        <div class="wrapper">
            ...
            <div class="content-container">
                ...
                <div class="users-ud-headers-container">
                    ...
                    <div class="block-b">Users Count</div>
                    <div class="block-c">Group Status</div>
                    <div class="block-d">Completed Status</div>
                    <div class="block-e">Action</div>
                </div>

                <div class="users-ud-container">

                    <?php foreach ($params['user-groups'] as $userGroup) { ?>
                        ...
                        <div class="users-ud-info">
                            ...
                            <div class="block-b">
                                ...
                                <p><?php echo $userGroup->users_count; ?></p>
                            </div>
                            <div class="block-c">
                                <div class="block-title">
                                    <p>Group Status</p>
                                ...
                                <p><?php if ($userGroup->completed_status) {
                                        echo "Live";
                                    } else {
                                        echo "Draft";
                                    } ?></p>
