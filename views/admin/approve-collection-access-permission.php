                        ...
                        <div class="item-info-container">
                            <div class='item-info-info-side'>
                                <div class='item-info-block'>
                                    ...
                                    <span>:</span>
                                    <p class='item-info'><?= $data->collection_path ?></p>
                                </div>
                            ...
                            <div class='item-info-btn-side'>
                                <form action="/admin/approve-collection-access-permission" method="POST">
                                ...
                                <form action="/admin/reject-collection-access-permission" method="POST">
                                    <input type='hidden' name='collection-id' value='<?= $data->collection_id ?>' />
                                    <input type='hidden' name='group-id' value='<?= $data->group_id ?>' />
