    ...
    <div id="update-user-main-content">
        ...
        <div class="wrapper">
            ...
            <div class="btn-row">
                ...
                <button class="btn <?php echo '' . ($params['upload_steps'] >= 2 ? "btn-info" : "btn-light") . ''; ?> mr-1 step-next-btn" onclick="window.location='/admin/upload-content/metadata?content_id=<?php echo $params['data']['content_id']; ?>';" <?php echo '' . ($params['upload_steps'] >= 2 ? "" : "disabled") . ''; ?>>Step 2</button>
